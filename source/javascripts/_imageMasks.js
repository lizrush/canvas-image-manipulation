...
ImageMasks.convertToDuoTone = function(imageData, pixelCount) {
  var pixels = imageData;
  var pixelArray = [];

  this.convertImageToGrayscale(pixels);
  ...
  var gradientArray = this.createGradient(green, red);
  ...
  for (var i = 0; i < pixelCount; i++) {
    ...
    var hsl = this.rgbToHsl(average, average, average);
...
ImageMasks.adjustBrightness = function(imageData, brightness) {
...
ImageMasks.convertImageToGrayscale = function(imageData) {
  var r, g, b, avg;
...
ImageMasks.createGradient = function(color1, color2) {
  var gradient = [];
...
ImageMasks.rgbToHsl = function (r, g, b) {
